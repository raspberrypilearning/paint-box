...
Teraz do projektu pridáš ceruzky rôznych farieb a umožníš používateľovi vybrať si medzi nimi.
...
```blocks3
pri prijatí správy [zelená v]
zmeň kostým na (ceruzka-zelená v)
nastav farbu pera na [#00CC44]
```
